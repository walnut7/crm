...
public class RequestSyncCustomerInfo extends Request implements Serializable  {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1383074792461617892L;
	...
	private List<RequestSyncContactInfo> contacts;
	
	private List<RequestSyncAccountInfo> accounts;
	
	private List<RequestSyncAttachmentInfo> attachs;
	...
	public List<RequestSyncContactInfo> getContacts() {
		return contacts;
	}

	public void setContacts(List<RequestSyncContactInfo> contacts) {
		this.contacts = contacts;
	}

	public List<RequestSyncAccountInfo> getAccounts() {
		return accounts;
	}

	public void setAccounts(List<RequestSyncAccountInfo> accounts) {
		this.accounts = accounts;
	}

	public List<RequestSyncAttachmentInfo> getAttachs() {
		return attachs;
	}

	public void setAttachs(List<RequestSyncAttachmentInfo> attachs) {
