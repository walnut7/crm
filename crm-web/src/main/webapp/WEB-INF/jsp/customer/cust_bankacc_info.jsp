	...
	<script type="text/javascript">
		...
		function append_b() {
			...
			if (endEditing_b()) {
				...
				$('#bank_info').datagrid('selectRow', editIndex_b).datagrid(
						'beginEdit', editIndex_b);
			}
		}
		...
		function removeit_b() {
			...
			if (node.id == "" || typeof (node.id) == "undefined") {
				$('#bank_info').datagrid('cancelEdit', editIndex_b).datagrid(
						'deleteRow', editIndex_b);
				editIndex_b = undefined;
				return;
			}
			var param = {
				...
				if (r) {
					if (node) {
						$.ajax({
							...
							success : function(data) {
								if (data == "SUCCESS") {
									$('#bank_info').datagrid('cancelEdit',
											editIndex_b).datagrid('deleteRow',
											editIndex_b);
									editIndex_b = undefined;
